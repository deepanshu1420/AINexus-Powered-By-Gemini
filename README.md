...
AI Nexus is a real-time AI neural interface powered by the Google `Gemini 2.5 Pro` API built using React, ReactMarkdown, Axios, Vite, Tailwind CSS, JavaScript (ES6+) and Socket.IO.
...
- 🎯 Fast, real-time AI responses with smooth interaction flow.  
